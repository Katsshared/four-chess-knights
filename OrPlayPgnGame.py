...
def main(board):
 ...
 #            st.page_link(f"", label="", icon="")
            ...
            st.page_link(f"https://en.wikipedia.org/wiki/Vasily_Smyslov", label="8. Vasily_Smyslov, Soviet Union, 1957-1958", icon="🟥")
            ...
            st.page_link(f"https://en.wikipedia.org/wiki/Wilhelm_Steinitz", label="1. Wilhelm_Steinitz, 🇦🇹-🇭🇺-🇺🇸 Austria-Hungary-United States, 1886–1894", icon="🇺🇸")
